...
function getI18n(key, lang)
{
	const i18n = {
		en: {
			...
			weatherCube_currentIndexLowDesc: '<b>Low danger</b>, from the sun\'s UV rays for the average person. Wear sunglasses on bright days. If you burn easily, cover up and use sunscreen.',
			weatherCube_currentIndexModerateDesc: '<b>Moderate risk</b>, of harm from unprotected sun exposure. Take precautions, such as covering up, if you will be outside. Stay in shade near midday when the sun is strongest.',
			weatherCube_currentIndexHighDesc: '<b>High risk</b>, of harm from unprotected sun exposure. Wear sunglasses and use SPF30+ sunscreen. Cover the body with sun protective clothing and a wide-brim hat. Reduce time in the sun from two hours before to three hours after solar noon.',
			weatherCube_currentIndexExtremeDesc: '<b>Very high</b>, risk of harm from unprotected sun exposure. Take extra precautions. Use SPF30+ sunscreen, a shirt, sunglasses and a hat. Do not stay out in the sun for too long. If you have to be outside avoid the sun from wo hours before to three hours after solar noon.',
			...
			weatherCube_geoError: 'It seems like Geolocation, which is required for this page, is not enabled in your browser.',
		...
		sl: {
			...
			weatherCube_currentIndexLowDesc: '<b>Majhna nevarnost,</b> sončnih UV žarkov za povprečno osebo. Nosite sončna očala v svetlih dneh. Če se zlahka opečete, se pokrijete in uporabite kremo za zaščito pred soncem.',
			weatherCube_currentIndexModerateDesc: '<b>Zmerno tveganje,</b> zaradi nezaščitenega izpostavljanja soncu. Bodite previdni, na primer pokrijte se, če boste zunaj. Ostanite v senci blizu poldneva, ko je sonce najmočnejše.',
			weatherCube_currentIndexHighDesc: '<b>Velika nevarnost,</b> zaradi nezaščitene izpostavljenosti soncu. Nosite sončna očala in uporabljajte zaščitno kremo SPF30 +. Telo pokrijte s zaščitnimi oblačili in klobukom s širokim obodom. Skrajšajte čas na soncu v času opoldanskih ur.',
			weatherCube_currentIndexExtremeDesc: '<b>Zelo veliko,</b> tveganje za poškodbe zaradi nezaščitenega izpostavljanja soncu. Upoštevajte dodatne varnostne ukrepe. Uporabite zaščitno kremo SPF30 +, majico, sončna očala in kapo. Ne ostajajte pod soncem predolgo. Če morate biti zunaj, se izogibajte soncu v času opoldanskih ur.',
			...
			weatherCube_geoError: 'Zdi se, da Geolokacija, ki je potrebna za to stran, v vašem brskalniku ni omogočena.',
			...
			weatherCube_earthSeasonsWinter: 'Zima',
			weatherCube_earthSeasonsSpring: 'Pomlad',
			weatherCube_earthSeasonsSummer: 'Poletje',
			weatherCube_earthSeasonsFall: 'Jesen',
			...
			weatherCube_earthAstrology: 'Trenutno Nebesno Znamenje:',
